...
@RestController
@RequestMapping("/Cita") //Introducimos una ruta para las métodos
public class CitaController {
    ...
    @PostMapping
    public CitaModel saveCita(@RequestBody CitaModel cita){
    ...
    @GetMapping(path = "/{id}")
    public Optional<CitaModel> getCitaById(@PathVariable Long id){
    ...
    @PutMapping(path = "/{id}")
    public CitaModel updateCitaById(@RequestBody CitaModel request, @PathVariable("id") Long id){
